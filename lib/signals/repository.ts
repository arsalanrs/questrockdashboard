...
const LOAN_SELECT =
  "id,current_stage,status_raw,loan_amount_cents,appraisal_ordered_at,appraisal_received_at,closed_at,closing_date,esign_returned_at,esign_requested_at,application_completed_at,submitted_to_processing_at,submitted_to_uw_at,ctc_at,lead_created_at,assigned_loan_officer_user_id,assigned_loan_officer_name,borrower_first_name,borrower_last_name,loan_type,loan_purpose,shape_record_id,lendingpad_loan_uuid,is_restructure_hold,note_rate_bps,original_rate_bps,property_value_cents,current_loan_balance_cents,ltv_bps,cltv_bps,dti_bps,credit_score_mid,is_veteran,arm_first_reset_date,arm_index,arm_margin_bps,do_not_contact,last_contacted_at,funded_at,loan_age_months,lead_tier,epo_date,epo_window_activated,reengagement_8month_completed_at,first_payment_date,note_date";
